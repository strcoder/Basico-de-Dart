...
void main() {
  ...
  var ingeniero = Ingeniero(123, 'Mariana', 250);

  ingeniero.calcularSalario();

  ingeniero.buenaConducta();

  var contador = Contador(987, 'Karen', 180);

  contador.calcularSalario();

  contador.buenaConducta();
}